...
def generate_channel_gains(n):
    """Generate uniform random channel gains between 0 and 1."""
    gains = np.random.normal(0, 1, size=n)
    return np.sort(gains)
...
# Number of users
n = 500000
h_threshold = 0.6  # Threshold for successful SIC
